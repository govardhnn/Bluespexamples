...
module mkCounter(CLK,
  ...
  wire CAN_FIRE_RL_count_up,
       CAN_FIRE_RL_done,
       CAN_FIRE_counter_value,
       CAN_FIRE_start_count,
       WILL_FIRE_RL_count_up,
       WILL_FIRE_RL_done,
       WILL_FIRE_counter_value,
       WILL_FIRE_start_count;
  ...
  assign CAN_FIRE_start_count = 1'd1 ;
  assign WILL_FIRE_start_count = EN_start_count ;

  // actionvalue method counter_value
  assign counter_value = x ;
  assign RDY_counter_value = 1'd1 ;
  assign CAN_FIRE_counter_value = 1'd1 ;
  assign WILL_FIRE_counter_value = EN_counter_value ;

  // rule RL_count_up
  assign CAN_FIRE_RL_count_up = x_ULT_30___d2 && start ;
  assign WILL_FIRE_RL_count_up = CAN_FIRE_RL_count_up ;

  // rule RL_done
  assign CAN_FIRE_RL_done = !x_ULT_30___d2 ;
  ...
  begin
    ...
    if (RST_N != `BSV_RESET_VALUE)
      if (WILL_FIRE_RL_done) $display("counting has finished at: %0d", x);
