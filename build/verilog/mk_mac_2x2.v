...
//
// On Sun Oct 22 10:17:05 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mk_mac_2x2(CLK,
  ...
  wire CAN_FIRE_RL_rl_recieve_stage1,
  ...
  assign RDY_ma_put_data =
	     !rg_initialized && !stage1 && !stage2 && !stage3 && !rg_done &&
	     mac_1$RDY_put_data ;
  ...
  assign RDY_mav_get_data =
	     rg_initialized && !stage1 && !stage2 && !stage3 && rg_done ;
  assign CAN_FIRE_mav_get_data = RDY_mav_get_data ;
  ...
  assign CAN_FIRE_RL_rl_recieve_stage1 =
	     mac_1$RDY_get_data && mac_2$RDY_put_data && mac_3$RDY_put_data &&
	     rg_initialized &&
	     stage1 &&
	     !stage2 &&
	     !stage3 &&
  ...
  assign CAN_FIRE_RL_rl_recieve_stage2 =
	     mac_2$RDY_get_data && mac_3$RDY_get_data && mac_4$RDY_put_data &&
	     rg_initialized &&
	     !stage1 &&
	     stage2 &&
	     !stage3 &&
  ...
  assign CAN_FIRE_RL_rl_recieve_stage3 =
	     mac_4$RDY_get_data && rg_initialized && !stage1 && !stage2 &&
	     stage3 &&
	     !rg_done ;
  ...
  // register stage1
  assign stage1$D_IN = !WILL_FIRE_RL_rl_recieve_stage1 ;
  assign stage1$EN = WILL_FIRE_RL_rl_recieve_stage1 || EN_ma_put_data ;
  ...
  // register stage3
  assign stage3$D_IN = !WILL_FIRE_RL_rl_recieve_stage3 ;
  assign stage3$EN =
	     WILL_FIRE_RL_rl_recieve_stage3 ||
	     WILL_FIRE_RL_rl_recieve_stage2 ;
  ...
  // submodule mac_2
  assign mac_2$put_data_i = mac_1$get_data[63:32] ;
  assign mac_2$put_data_j = rg_j1_in ;
  assign mac_2$EN_put_data = CAN_FIRE_RL_rl_recieve_stage1 ;
  assign mac_2$EN_get_data = CAN_FIRE_RL_rl_recieve_stage2 ;

  // submodule mac_3
  assign mac_3$put_data_i = rg_i1_in ;
  assign mac_3$put_data_j = mac_1$get_data[31:0] ;
  assign mac_3$EN_put_data = CAN_FIRE_RL_rl_recieve_stage1 ;
  assign mac_3$EN_get_data = CAN_FIRE_RL_rl_recieve_stage2 ;

  // submodule mac_4
  assign mac_4$put_data_i = mac_3$get_data[63:32] ;
  assign mac_4$put_data_j = mac_2$get_data[31:0] ;
  assign mac_4$EN_put_data = CAN_FIRE_RL_rl_recieve_stage2 ;
