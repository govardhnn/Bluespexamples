...
//
// On Fri Aug 18 14:55:09 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkFIFO_8_to_1_Byte(CLK,
  ...
  wire dut_f_1_i_notEmpty__4_AND_dut_f_2_i_notEmpty___ETC___d56,
  ...
  assign RDY_get_get =
	     dut_f_0$EMPTY_N &&
	     dut_f_1_i_notEmpty__4_AND_dut_f_2_i_notEmpty___ETC___d56 ;

  // submodule dut_f_0
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_0(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_0$D_IN),
						 .ENQ(dut_f_0$ENQ),
						 .DEQ(dut_f_0$DEQ),
  ...
  // submodule dut_f_1
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_1(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_1$D_IN),
						 .ENQ(dut_f_1$ENQ),
						 .DEQ(dut_f_1$DEQ),
  ...
  // submodule dut_f_2
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_2(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_2$D_IN),
						 .ENQ(dut_f_2$ENQ),
						 .DEQ(dut_f_2$DEQ),
  ...
  // submodule dut_f_3
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_3(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_3$D_IN),
						 .ENQ(dut_f_3$ENQ),
						 .DEQ(dut_f_3$DEQ),
  ...
  // submodule dut_f_4
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_4(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_4$D_IN),
						 .ENQ(dut_f_4$ENQ),
						 .DEQ(dut_f_4$DEQ),
  ...
  // submodule dut_f_5
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_5(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_5$D_IN),
						 .ENQ(dut_f_5$ENQ),
						 .DEQ(dut_f_5$DEQ),
  ...
  // submodule dut_f_6
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_6(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_6$D_IN),
						 .ENQ(dut_f_6$ENQ),
						 .DEQ(dut_f_6$DEQ),
  ...
  // submodule dut_f_7
  FIFO2 #(.width(32'd8), .guarded(1'd1)) dut_f_7(.RST(RST_N),
						 .CLK(CLK),
						 .D_IN(dut_f_7$D_IN),
						 .ENQ(dut_f_7$ENQ),
						 .DEQ(dut_f_7$DEQ),
  ...
  // remaining internal signals
  assign dut_f_1_i_notEmpty__4_AND_dut_f_2_i_notEmpty___ETC___d56 =
	     dut_f_1$EMPTY_N && dut_f_2$EMPTY_N && dut_f_3$EMPTY_N &&
	     dut_f_4$EMPTY_N &&
	     dut_f_5$EMPTY_N &&
	     dut_f_6$EMPTY_N &&
	     dut_f_7$EMPTY_N ;
